  ...
  return (
    <MainLayout noHeader noBottomNav>
      <div className="relative h-72 md:h-96 w-full bg-gray-100">
        <Link href={`/vendor/${product.vendorId}`} className="absolute top-10 left-4 z-10 w-10 h-10 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-sm active:scale-95">
