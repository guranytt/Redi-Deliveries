  ...
  return (
    <MainLayout noHeader noBottomNav>
      ...
      <div className="relative h-64 md:h-80 w-full">
        <Link href="/" className="absolute top-10 left-4 z-10 w-10 h-10 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-sm active:scale-95">
      ...
      <div className="px-4 py-6 space-y-6 bg-gray-50 pb-32">
        ...
        {menuItems.map(menuItem => (
          ...
          <Link href={`/product/${menuItem.id}`} className="bg-white rounded-3xl p-4 shadow-sm border border-gray-100 flex h-36 relative active:scale-[0.98] transition-transform">
