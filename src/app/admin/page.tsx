      ...
      <div className="p-4 space-y-6 pb-24">
         ...
         <div className="grid grid-cols-2 gap-4">
            <div className="bg-red-50 rounded-3xl p-5 border border-red-100">
               <div className="bg-white w-10 h-10 rounded-full flex items-center justify-center mb-3 shadow-sm text-red-600">
         ...
         <div className="space-y-4">
            <div className="flex justify-between items-center">
               ...
               <button className="text-red-600 font-bold text-sm">View Map</button>
            </div>
               ...
               {MOCK_ORDERS.filter(o => o.status !== 'Delivered').map(order => (
                  <div key={order.id} className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
                     <div className="flex justify-between items-start mb-2">
                        <div>
                           <span className="bg-red-50 text-red-700 text-xs font-bold px-2 py-1 rounded-md">{order.status}</span>
